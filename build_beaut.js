...
(function(window) {
    ...
    if (/Chrome\/8[45]\./.test(window.navigator.userAgent)) {
        window["alert"]("Your browser version contains a bug that makes the game run very poorly.\nIt is recommended that you update to Chrome 86 or newer, or use Chrome Canary for best performance.")
    }
    ...
    var DYNAMIC_BASE = 5426112,
        DYNAMICTOP_PTR = 183072;
    ...
    var wasmBinaryFile = "build_6f59094d60f98fafc14371671d3ff31ef4d75d9e.wasm.wasm";
    ...
    var ASM_CONSTS = {
        ...
        13414: function($0, $1, $2, $3) {
            cp5.contexts[$0].fillStyle = "rgb(" + $1 + "," + $2 + "," + $3 + ")"
        },
        13493: function($0, $1, $2, $3, $4, $5, $6) {
        ...
        13863: function($0, $1, $2, $3) {
            cp5.contexts[$0].strokeStyle = "rgb(" + $1 + "," + $2 + "," + $3 + ")"
        },
        13939: function($0, $1, $2, $3, $4) {
    ...
    var asmLibraryArg = {
        "i": ___assert_fail, // Z_aZ_iZ_viiii
        "q": ___map_file, // Z_aZ_qZ_iii
        "p": ___sys_munmap, // Z_aZ_pZ_iii
        "b": _abort, // Z_aZ_bZ_vv
        "d": _emscripten_asm_const_dii, // Z_aZ_dZ_diii
        "a": _emscripten_asm_const_iii, // Z_aZ_aZ_iiii
        "j": _emscripten_exit_with_live_runtime, // Z_aZ_jZ_vv
        "m": _emscripten_force_exit, // Z_aZ_mZ_vi
        "g": _emscripten_get_now, // Z_aZ_gZ_dv
        "n": _emscripten_memcpy_big, // Z_aZ_nZ_iiii
        "e": _emscripten_random, // Z_aZ_eZ_fv
        "f": _emscripten_resize_heap, // Z_aZ_fZ_ii
        "r": _emscripten_set_main_loop, // Z_aZ_rZ_viii
        "k": _environ_get, // Z_aZ_kZ_iii
        "l": _environ_sizes_get, // Z_aZ_lZ_iii
        "h": _fd_write, // Z_aZ_hZ_iiiii
        "memory": wasmMemory,
        "c": _roundf, // Z_aZ_cZ_ff
        "o": _strftime_l, // Z_aZ_oZ_iiiiii
        "table": wasmTable
    };
    var asm = createWasm();
    ...
    var _d_connect = Module["_d_connect"] = function() {
        return (_d_connect = Module["_d_connect"] = Module["asm"]["t"]).apply(null, arguments)
    };
    var _has_tank = Module["_has_tank"] = function() {
        return (_has_tank = Module["_has_tank"] = Module["asm"]["u"]).apply(null, arguments)
    };
    var _set_convar = Module["_set_convar"] = function() {
        return (_set_convar = Module["_set_convar"] = Module["asm"]["v"]).apply(null, arguments)
    };
    var _get_convar = Module["_get_convar"] = function() {
        return (_get_convar = Module["_get_convar"] = Module["asm"]["w"]).apply(null, arguments)
    };
    var _execute = Module["_execute"] = function() {
        return (_execute = Module["_execute"] = Module["asm"]["x"]).apply(null, arguments)
    };
    var _print_convar_help = Module["_print_convar_help"] = function() {
        return (_print_convar_help = Module["_print_convar_help"] = Module["asm"]["y"]).apply(null, arguments)
    };
    var _main = Module["_main"] = function() {
        return (_main = Module["_main"] = Module["asm"]["z"]).apply(null, arguments)
    };
    var _cp5_check_ws = Module["_cp5_check_ws"] = function() {
        return (_cp5_check_ws = Module["_cp5_check_ws"] = Module["asm"]["A"]).apply(null, arguments)
    };
    var _free = Module["_free"] = function() {
        return (_free = Module["_free"] = Module["asm"]["B"]).apply(null, arguments)
    };
    var _videoads_loaded = Module["_videoads_loaded"] = function() {
        return (_videoads_loaded = Module["_videoads_loaded"] = Module["asm"]["C"]).apply(null, arguments)
    };
    var _videoads_done = Module["_videoads_done"] = function() {
        return (_videoads_done = Module["_videoads_done"] = Module["asm"]["D"]).apply(null, arguments)
    };
    var _set_mouse_pos = Module["_set_mouse_pos"] = function() {
        return (_set_mouse_pos = Module["_set_mouse_pos"] = Module["asm"]["E"]).apply(null, arguments)
    };
    var _set_key_down = Module["_set_key_down"] = function() {
        return (_set_key_down = Module["_set_key_down"] = Module["asm"]["F"]).apply(null, arguments)
    };
    var _set_key_up = Module["_set_key_up"] = function() {
        return (_set_key_up = Module["_set_key_up"] = Module["asm"]["G"]).apply(null, arguments)
    };
    var _reset_keys = Module["_reset_keys"] = function() {
        return (_reset_keys = Module["_reset_keys"] = Module["asm"]["H"]).apply(null, arguments)
    };
    var _prevent_right_click = Module["_prevent_right_click"] = function() {
        return (_prevent_right_click = Module["_prevent_right_click"] = Module["asm"]["I"]).apply(null, arguments)
    };
    var _flush_input_hooks = Module["_flush_input_hooks"] = function() {
        return (_flush_input_hooks = Module["_flush_input_hooks"] = Module["asm"]["J"]).apply(null, arguments)
    };
    var _mouse_wheel = Module["_mouse_wheel"] = function() {
        return (_mouse_wheel = Module["_mouse_wheel"] = Module["asm"]["K"]).apply(null, arguments)
    };
    var _cp5_idle = Module["_cp5_idle"] = function() {
        return (_cp5_idle = Module["_cp5_idle"] = Module["asm"]["L"]).apply(null, arguments)
    };
    var _cp5_destroy = Module["_cp5_destroy"] = function() {
        return (_cp5_destroy = Module["_cp5_destroy"] = Module["asm"]["M"]).apply(null, arguments)
    };
    var _game_pow_solve_result = Module["_game_pow_solve_result"] = function() {
        return (_game_pow_solve_result = Module["_game_pow_solve_result"] = Module["asm"]["N"]).apply(null, arguments)
    };
